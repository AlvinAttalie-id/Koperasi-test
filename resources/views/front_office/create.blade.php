...
@php
    $title = 'Create Front Office Account';
    $breadcrumb = ['Home', 'Front Office', 'Create'];
@endphp

@section('title', 'Create Front Office')

@section('content')
<div class="max-w-xl mx-auto space-y-6">
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-xl font-bold text-gray-900">Add Front Office</h2>
    ...
    <x-card>
        <form method="POST" action="{{ route('front-offices.store') }}" class="space-y-6">
            @csrf
